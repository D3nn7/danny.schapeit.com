      ...
      <body className={roboto.className}>
        <div className="flex justify-center flex-col max-h-[64rem] min-h-screen">
          ...
          <div className="flex min-h-screen flex-col items-center px-6 lg:px-5 xl:px-36 2xl:px-64 text-gray-300">
            <Link
              href={"https://holopin.io/collect/clfh7d7uc32160fjmhvwvnfvx"}
              target="_blank"
            >
              <Image
                src={"/logo.png"}
            ...
            {process.env.NEXT_PUBLIC_TWITCH_LIVE === "true" ? (
              <StreamBanner />
            ) : null}
            <h1 className="font-high-summit text-4xl md:text-6xl text-silver mb-4">
              Danny Schapeit
            </h1>
