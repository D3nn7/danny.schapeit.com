    ...
    <main className="items-center space-y-8">
      ...
      <div>
        ...
        <ol className="relative border-l border-gray-400 space-y-4">
          ...
          />
          <TimelineItem
            title="General Secondary Education (Hauptschule and Realschule)"
            time="2009 - 2020"
            extraInfos="Completed lower and intermediate secondary education in Germany, providing a strong foundation in general academics and practical subjects"
          />
        </ol>
      </div>

      <div>
        <h4 className="font-high-summit text-2xl text-silver">
          Certifications
        </h4>
        <ol className="relative border-l border-gray-400 space-y-4">
          <TimelineItem
            title="Certified Samsung Galaxy Business Associate 2025"
            time="27. March 2025"
            extraInfos="Samsung Electronics"
          />
          <TimelineItem
            title="Samsung Knox Certified Associate 2025"
            time="27. March 2025"
            extraInfos="Samsung Electronics"
          />
          <TimelineItem
            title="Trainer for Apprentices (Software Development)"
            time="6. November 2024"
            extraInfos="IHK Aschaffenburg"
          />
          <TimelineItem
            title="Qualification of Apprenticeship as IT specialist for application development"
            time="26. July 2023"
            extraInfos="SPEDION GmbH, IHK, Berufsschule Miltenberg Obernburg"
          />
          <TimelineItem
